...
_Gruppenname:_ *{group.title}*

== Bezeichnung: *{game.title}*

== Zielgruppe: *Menschen mit wenig Erfahrung im Umgang mit Computern*

== Inhalt

Das Lernspiel {game.title} hat es sich zur Aufgabe gemacht, älteren Menschen ohne weitere entsprechende Vorkenntnisse den Umgang mit dem Computer näherzubringen.
